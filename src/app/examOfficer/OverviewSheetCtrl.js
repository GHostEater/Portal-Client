 ...
 */
angular.module("b")
  .controller("OverviewSheetCtrl",function(Access,CurrentUser,Lecturer,Hod,LevelAdviser,Dept,College,CourseToMajor,CourseReg,CourseWaving,CourseResult,CourseResultGPA,Level,Major,Student,Session,Semester,lodash,$window){
    Access.lecturer();
    var vm = this;
    vm.print = print;
